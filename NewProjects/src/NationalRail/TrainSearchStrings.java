...
public class TrainSearchStrings 
{
...
//		driver.manage().window().maximize();
			...
			) throws InterruptedException
	{
		...
		driver.findElement(By.id("txtFrom")).sendKeys(from);
		
		driver.findElement(By.id("txtTo")).clear();
		driver.findElement(By.id("txtTo")).sendKeys(to);
...
//		driver.findElement(By.xpath("//*[@id='sltHours']//[11]")).click();
	...
	@DataProvider
	public Object[][] RailSearch()
	{
		
		ExcelDataConfig config=new ExcelDataConfig("C:\\Users\\mardarri\\workspace\\NewProjects\\src\\NationalRail\\RailFares.xlsx");
